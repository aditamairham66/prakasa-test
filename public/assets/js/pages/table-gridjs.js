class GridDatatable {
 ...
 basicTableInit() {
     ...
     document.getElementById("table-pagination") && new gridjs.Grid({
         columns: [{
             name: "ID",
             width: "120px",
             formatter: function(e) {
     ...
     document.getElementById("table-loading-state") && new gridjs.Grid({
         columns: ["Name", "Email", "Position", "Company", "Country"],
         pagination: {
             limit: 5
         },
     ...
     document.getElementById("table-fixed-header") && new gridjs.Grid({
         columns: ["Name", "Email", "Position", "Company", "Country"],
         sort: !0,
         pagination: !0,
         fixedHeader: !0,
     ...
     document.getElementById("table-hidden-column") && new gridjs.Grid({
